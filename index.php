						...
						<form action="book_flight.php" method="post">
							...
							<div class="date">
								...
								<div class="return">
									...
									<input class="form-control"  name="return_date" type="date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
								</div>
								<div class="clear"></div>
							</div>
							<div class="class">
...
<!-- <div class="conatiner-fluid p-4" style="background-color: blacksmoke;margin-top:150px;"> -->
	...
	<em><h5 class="text-light text-center p-0 brand mt-2">
			...
			Flight Reservation System</h5></em>
	<div class="text-light text-center">&copy; <?php echo date('Y')?>
